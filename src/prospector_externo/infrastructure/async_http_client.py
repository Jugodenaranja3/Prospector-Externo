...
class AsyncResilientHttpClient:
    ...
    def __init__(
        ...
        *,
        ...
        if timeout is not None:
            ...
            cfg = timeout_config or HttpTimeoutConfig()
    ...
    async def _consume_budget(self) -> bool:
        if self._request_budget is None:
            return True
        return await self._request_budget.consume()
    ...
    async def _send_request(
        ...
        *,
        ...
        conditional_headers = (
            self._conditional_cache.headers_for(url)
            if conditional
            else {}
        )
        ...
        for attempt in range(1, self._retry_policy.max_attempts + 1):
            ...
            try:
                ...
                await self._politeness.defer(
                    host,
                    self._retry_policy.backoff_for_attempt(attempt),
                )
                continue
            ...
            # Revalidación condicional: 304 es resultado válido, no error.
            ...
            if conditional:
                self._conditional_cache.observe(
                    url,
